...
const initialLogos: Omit<Logo, 'enhancedSrc' | 'isEnhancing'>[] = [
  { id: 1, name: "TechCorp", originalSrc: "https://placehold.co/150x75.png?text=TechCorp" },
  { id: 2, name: "Innovate Inc.", originalSrc: "https://placehold.co/150x75.png?text=Innovate" },
  { id: 3, name: "Global Solutions", originalSrc: "https://placehold.co/150x75.png?text=Global" },
  { id: 4, name: "NextGen", originalSrc: "https://placehold.co/150x75.png?text=NextGen" },
  { id: 5, name: "Future Systems", originalSrc: "https://placehold.co/150x75.png?text=Future" },
  { id: 6, name: "Quantum Leap", originalSrc: "https://placehold.co/150x75.png?text=Quantum" },
  { id: 7, name: "Pioneer", originalSrc: "https://placehold.co/150x75.png?text=Pioneer" },
  { id: 8, name: "Synergy", originalSrc: "https://placehold.co/150x75.png?text=Synergy" },
];
    ...
    <section className="py-20 md:py-28 bg-card">
      <div className="container mx-auto px-4">
        ...
        <div className="w-full overflow-hidden" style={{ maskImage: "linear-gradient(to right, transparent, black 10%, black 90%, transparent)"}}>
          <div className={cn("flex gap-8 animate-scroll", isEnhancingAll && "paused")}>
